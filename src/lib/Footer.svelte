...
<footer class="flex gap-8 justify-center items-center bg-primary text-primary-content p-4 mt-20">
    <span class="text-sm">
        © {new Date().getFullYear()} James Reed
    </span>
    <div class="flex gap-2">
        <a href={PUBLIC_GITHUB_PROFILE_URL}>
        ...
        <a href={PUBLIC_BLOG_URL}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="m22.351 8.019l-6.37-6.37a5.63 5.63 0 0 0-7.962 0l-6.37 6.37a5.63 5.63 0 0 0 0 7.962l6.37 6.37a5.63 5.63 0 0 0 7.962 0l6.37-6.37a5.63 5.63 0 0 0 0-7.962M12 15.953a3.953 3.953 0 1 1 0-7.906a3.953 3.953 0 0 1 0 7.906"/></svg>
        </a>
    </div>
</footer>
