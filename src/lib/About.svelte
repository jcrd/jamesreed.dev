...
<div id="#about" class="h-2/3 scroll-mt-32 w-full p-24 border-2 border-black relative flex flex-col items-center justify-center gap-24">
    ...
    <div class="grid grid-cols-2 px-24">
        ...
        <div class="bg-white flex flex-col justify-center gap-4">
            <span class="text-4xl">
                {@html aboutData.whoami}
            </span>
            <span class="text-xl prose">
                {aboutData.blurb}
            </span>
        </div>
    </div>
